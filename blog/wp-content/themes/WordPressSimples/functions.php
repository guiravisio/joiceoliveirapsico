...
function joice_enqueue_styles() {
    ...
    wp_enqueue_script('bootstrap', get_stylesheet_directory_uri() . '/static/bootstrap/js/bootstrap.bundle.min.js', [], null, true);
    wp_enqueue_script('script', get_stylesheet_directory_uri() . '/static/script.js', [], null, true);
}
